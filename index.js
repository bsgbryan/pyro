...
(function() {
  var Firebase, add_leaf, add_value, async, biggest, count, counts, execute_query, exist, exists, find, firebase, get, increment_count, monitor, priority, push, q, remove, sanitize, set, smallest, to, touch, unmonitor, unwatch, watch,
    __slice = [].slice;
